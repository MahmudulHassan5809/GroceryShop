$(document).ready(function(){
    ...
    $('#1_star').hover(function(){
        $('#1_star').attr('src', '/img/star_on.png');
        $('#2_star').attr('src', '/img/star_off.png');
        $('#3_star').attr('src', '/img/star_off.png');
        $('#4_star').attr('src', '/img/star_off.png');
        $('#5_star').attr('src', '/img/star_off.png');
    ...
    $('#2_star').hover(function(){
        $('#1_star').attr('src', '/img/star_on.png');
        $('#2_star').attr('src', '/img/star_on.png');
        $('#3_star').attr('src', '/img/star_off.png');
        $('#4_star').attr('src', '/img/star_off.png');
        $('#5_star').attr('src', '/img/star_off.png');
    ...
    $('#3_star').hover(function(){
        $('#1_star').attr('src', '/img/star_on.png');
        $('#2_star').attr('src', '/img/star_on.png');
        $('#3_star').attr('src', '/img/star_on.png');
        $('#4_star').attr('src', '/img/star_off.png');
        $('#5_star').attr('src', '/img/star_off.png');
    ...
    $('#4_star').hover(function(){
        ...
        $('#2_star').attr('src', '/img/star_on.png');
        $('#3_star').attr('src', '/img/star_on.png');
        $('#4_star').attr('src', '/img/star_on.png');
        $('#5_star').attr('src', '/img/star_off.png');
    ...
    $('#5_star').hover(function(){
        ...
        $('#3_star').attr('src', '/img/star_on.png');
        $('#4_star').attr('src', '/img/star_on.png');
        $('#5_star').attr('src', '/img/star_on.png');
